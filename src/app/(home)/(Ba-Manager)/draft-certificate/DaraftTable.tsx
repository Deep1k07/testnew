...
function DaraftTable({ responseData }: any) {
    return (
        <Table>
            <TableHeader>
                <TableRow>
                    ...
                    responseData ?
                        responseData?.map((ele: any, index: any) => (
                            <TableRow key={index}>
                                ...
                                <TableCell>
                                    <a className='bg-green-600  inline-block px-2 py-2 rounded-md text-white hover:bg-green-600/90' target='_blank' href={ele.s3DraftPdfxUrl}> <ArrowDownToLine size={16} /></a>
                                </TableCell>
                            </TableRow>
                        )) : (
                            <TableRow>
